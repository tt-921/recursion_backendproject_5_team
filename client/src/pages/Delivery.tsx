      ...
      <div className="grid grid-cols-2 gap-15">
                ...
                <div>
                  ...
                  <div className="mb-5">
                    <Label htmlFor="phone" className="mb-2 flex justify-between">
                      電話番号
                      <span className="text-gray-400 text-xm">ハイフンなし</span>
                    </Label>
                    <Input className="w-full text-sm" placeholder="電話番号を入力してください" />
                  </div>
                  <div className="mb-5">
                    <Label htmlFor="postal" className="mb-2 flex justify-between">
                      郵便番号（半角数字）
                      <span className="text-gray-400 text-xm">ハイフンなし</span>
                    </Label>
                  ...
                  <div className="mb-5">
                    <Label htmlFor="prefecture" className="mb-2">都道府県</Label>
                    <Select>
                  ...
                  <div className="mb-5">
                    <Label htmlFor="city" className="mb-2">市区町村</Label>
                    <Input className="w-full text-sm" placeholder="例：〇〇市〇〇町" />
                  </div>
                  <div className="mb-5">
                    <Label htmlFor="address" className="mb-2">丁目・番地・号（数字は半角数字）</Label>
                    <Input className="w-full text-sm" placeholder="例：1-2-3" />
                  </div>
                  <div className="mb-5">
                    <Label htmlFor="building" className="mb-2">建物名</Label>
                    <Input className="w-full text-sm" placeholder="例：〇〇〇マンション" />
                  </div>
                  <div className="mb-5">
                    <Label htmlFor="room" className="mb-2">部屋番号（数字は半角数字）</Label>
                    <Input className="w-full text-sm" placeholder="例：123" />
                  </div>
                </div>
                <DialogFooter className="sm:justify-start">
                  <Button className="w-full">変更する</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          </section>
          ...
          <section className="mb-6">
            ...
            <RadioGroup defaultValue="option-one">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="option-three">一部のみ利用する</Label>
              </div>
              <Input placeholder="利用するポイント数" className="ml-5 w-full max-w-xs text-sm" />
            </RadioGroup>
          </section>
        ...
        <div>
          <section className="mb-6">
            ...
            <Button
              variant="link"
              className="text-sm flex justify-end p-0 rounded-none hover:no-underline ml-auto mb-4"
            >
              キャンセル・ポリシーについて
              <ChevronRight />
            </Button>
